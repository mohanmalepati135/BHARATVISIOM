        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
              ...
              <StatCard label="Avg. evaluation score" value={(stats.averageEvaluationScore ?? 0).toFixed(1)} icon={Star} tone="warm" />
              <StatCard label="Most preferred model" value={stats.mostPreferredModel || 'N/A'} icon={Trophy} tone="accent" />
